...
public class Enemigos extends JPanel implements ActionListener{
	...
	public void paintComponent(Graphics g) {
		...
		rect1 = new Rectangle2D.Double(x+espacio, y, 30, 30);
	...
	public void anadisLista() {
		listaEnemigos.add(rect);
		listaEnemigos.add(rect1);
		listaEnemigos.add(rect2);
		listaEnemigos.add(rect3);
		listaEnemigos.add(rect4);
		listaEnemigos.add(rect5);
	}
